...
date = input("Please Enter the date in the following format MM/DD/YYY")
...
def main(page):
    ...
    def get_match_info(championships):
        ...
        for i in range(number_of_matches):
            ...
            matches_details.append({"نوع البطوله": championship_title , "الفريق الاول":team_A , " الفريق التاني ":team_B , "time":time , "score":score})
    ...
    with open("matches-details3.csv","w", encoding="utf-8", newline="") as output_file:
